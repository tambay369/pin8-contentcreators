...
@keyframes pulse {
    ...
    50% { opacity: 0.05; transform: translate(-50%, -50%) scale(1.08); }
}
...
.hero {
    ...
    background: linear-gradient(135deg, rgba(212,175,55,0.12) 0%, rgba(0,0,0,1) 60%);
...
.price-card:hover .card-border {
    opacity: 1;
}

.price-card.featured {
    border-color: #FFD700;
    background: linear-gradient(135deg, rgba(212,175,55,0.08) 0%, rgba(0,0,0,0.7) 100%);
...
footer {
    ...
    position: relative;
    z-index: 1;
    background: linear-gradient(135deg, rgba(212,175,55,0.05) 0%, rgba(0,0,0,1) 100%);
}
...
@media (max-width: 1024px) {
    .features, .grid-4, .grid-3, .comparison { grid-template-columns: repeat(2, 1fr); }
...
@media (max-width: 768px) {
    ...
    .features, .grid-4, .grid-3, .comparison { grid-template-columns: 1fr; }
    .form-row { grid-template-columns: 1fr; }
    .box { padding: 40px 25px; }
    .form { padding: 40px 25px; }
    .hero-btns { flex-direction: column; align-items: center; }
}

@media (max-width: 480px) {
    .hero h1 { font-size: 2rem; letter-spacing: 0.3rem; }
    .tagline { font-size: 1.1rem; }
    .section-title { font-size: 1.7rem; }
    .btn { padding: 16px 40px; font-size: 0.95rem; }
